...
def test_normal_title():
    cmd_create('JJC-TEST-E2E-03', '调研工业数据分析大模型应用方案', 'Zhongshu', '中书省', '中书令', '司礼监承旨分办')
...
def test_flow_remark_cleaned():
    ...
    cmd_flow('JJC-TEST-E2E-04', '司礼监', '中书省', '旨意传达：审查/Users/bingsen/clawd/xxx项目 Conversation blah')
