...
Write-Host "  2. 启动 v2 栈:        docker compose -f edict/docker-compose.yml up --build"
Write-Host "  3. 打开前端:          http://127.0.0.1:3000"
Write-Host "  4. FastAPI 健康检查:   http://127.0.0.1:8000/health"
Write-Host ""
